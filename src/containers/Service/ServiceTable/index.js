  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'payment_method',
        render: servicelines => {
          let payment_method = servicelines !== undefined && servicelines[0] !== undefined ? servicelines[0].payment_method : 'N/A'
          return (
    ...
    return (
      <div>
        <Table rowKey={record => record.id}  onChange={this.handleChange} dataSource={this.props.serviceList} columns={columns} />
      </div>
    )
  }
}
