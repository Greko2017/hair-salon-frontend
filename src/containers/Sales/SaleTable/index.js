  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'payment_method',
        render: salelines => {
          let payment_method = salelines !== undefined && salelines[0] !== undefined ? salelines[0].payment_method : 'N/A'
          return (
    ...
    return (
      <div>
        <Table rowKey={record => record.id}  onChange={this.handleChange} dataSource={this.props.saleList} columns={columns} />
      </div>
    )
  }
}
