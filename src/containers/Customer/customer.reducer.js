import {INITIATE_CUSTOMER_FAILURE,INITIATE_CUSTOMER_REQUEST,FETCH_CUSTOMER_SUCCESS, HANDLE_CUSTOMER_MODAL_SHOW, HANDLE_CUSTOMER_MODAL_CANCEL, POST_CUSTOMER_SUCCESS, SET_CUSTOMER_MODAL_ITEM, DELETE_CUSTOMER_SUCCESS} from './customer.constants'
const initialState = {
  loading: false,
  customers: [],
