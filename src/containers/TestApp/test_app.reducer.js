import { EDIT_ACCOUNT_DETAILS_SUCCESS, EDIT_TEST_CUSTOMER_SUCCESS, FETCH_TEST_CUSTOMER_SUCCESS, GET_ACCOUNT_DETAILS_BY_USER_ID, INITIATE_TEST_CUSTOMER_FAILURE, INITIATE_TEST_CUSTOMER_REQUEST } from "./test_app.constant";
      ...
      case INITIATE_TEST_CUSTOMER_FAILURE:
          ...
          case EDIT_TEST_CUSTOMER_SUCCESS:
            ...
            return {
                ...
                customer: payload,
                error: "",
                customer: [...state.customer.map(_account_details => {
